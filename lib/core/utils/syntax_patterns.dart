class SyntaxPatterns {
  ...
  static final RegExp financePrefix = RegExp(
    r'^([+-]?\s?[$€]?\s?\d+(\.\d+)?\s?[$€]?)\s',
  );
  ...
  static final RegExp dateCommands = RegExp(
    r'/(hoy|mañana|lunes|martes|miercoles|jueves|viernes|sabado|domingo|tarde|noche)',
  );
}
